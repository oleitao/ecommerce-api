...
namespace WebApi.Migrations
{
    ...
    [Migration("20240614154200_AddedShopAvatars")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "8d63398b-af78-43ed-9ea7-1c099807fa08",
                            Name = "Manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "39ff361e-761a-4a1a-bae7-3f93cce8fce1",
                            Name = "Administrator",
            ...
            modelBuilder.Entity("Model.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1ad08ba2-1cf0-4af4-84d1-67e391f4e38c"),
                        ...
                        new
                        {
                            Id = new Guid("a51fd6b6-0487-4e96-9ce2-e574c4b782dd"),
                        ...
                        new
                        {
                            Id = new Guid("16347a02-0f1b-4c0c-9f32-f3c53041452f"),
                        ...
                        new
                        {
                            Id = new Guid("7a115efd-47fa-46e8-8fb6-d5cba0d09f1f"),
                        ...
                        new
                        {
                            Id = new Guid("dd88965a-e5bc-4f9b-a25e-79d5c09f159d"),
                        ...
                        new
                        {
                            Id = new Guid("a3fbf5fd-252e-4aef-b7f0-17ae60005867"),
                        ...
                        new
                        {
                            Id = new Guid("d94d1754-2c61-4ee7-8c80-727f61063199"),
                        ...
                        new
                        {
                            Id = new Guid("12f77019-2da5-4ecf-aac0-c35d1a432a5f"),
                        ...
                        new
                        {
                            Id = new Guid("b07fda7c-c7ac-4a90-bf17-386c0fc6d0a4"),
                        ...
                        new
                        {
                            Id = new Guid("a89b6425-eddb-4449-bd9a-81f3a6b98287"),
                            ImageUrl = "",
                            SubTitle = "",
                            Title = "Others"
                        });
            ...
            modelBuilder.Entity("Model.ShopAvatar", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5616cd97-cbf7-4f30-9e90-ac5fe1eed5d3"),
                            Publicid = "test",
                        ...
                        new
                        {
                            Id = new Guid("e31aedb7-b361-4e6d-bdbe-53289ac1ca00"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Url = "https://www.hatchwise.com/wp-content/uploads/2022/05/amazon-logo-1024x683.png"
                        },
                        new
                        {
                            Id = new Guid("b55ace71-435e-48b7-b980-17cb84aa633d"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Url = "https://www.hatchwise.com/wp-content/uploads/2022/05/amazon-logo-1024x683.png"
                        },
                        new
                        {
                            Id = new Guid("1e85693b-a893-4d8e-bea9-6102e1c33f83"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("d46e2c5a-0e2f-4e65-8b96-e1af3414dedf"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("476d3387-9a9d-405f-85cf-f4adb79e7d12"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("49470638-d5f1-4ba0-b2c4-a832f94e42b1"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("c42e75a0-4ae8-4a83-a44f-1f80f912143d"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("478f7f95-ad65-4cde-bb52-3b131eb2af9d"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("f5b67fd1-9932-4372-bad0-3d8311267f78"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Url = "data:image/png;base64,"
                        },
                        new
                        {
                            Id = new Guid("7bf09e87-f4d8-4338-8847-e2f2bad14915"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("b390604a-06d5-4cd2-9347-7beaacf58c23"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("c4f552d5-88c0-44c7-916b-c5b8847a5525"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("5b0cac3e-80e0-42f3-b8c9-8ed9460d35c1"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("2315d9c0-b968-46c1-9b84-5d77cd3934f8"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("4aa1bbb8-6f2d-40eb-a19f-80d40062f355"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("4b0cf93e-b5cc-4150-8990-73b36f59cdf5"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("965fea55-4bc8-4f10-b565-c8729086fdde"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("80cc34b9-f311-4ea4-8be4-eec8557c20e4"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("9821c925-2df0-41cf-adae-387beb8eb509"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("877ff312-4833-47aa-85ba-ebf8de9ce539"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Url = "data:image/png;base64,"
                        },
                        new
                        {
                            Id = new Guid("f1623f36-69f9-4e7b-93b3-e6731576638c"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Url = "https://www.hatchwise.com/wp-content/uploads/2022/05/amazon-logo-1024x683.png"
                        },
                        new
                        {
                            Id = new Guid("2f2073e6-7ff3-4d52-b175-8c20d70ea6d0"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Url = "https://www.hatchwise.com/wp-content/uploads/2022/05/amazon-logo-1024x683.png"
                        },
                        new
                        {
                            Id = new Guid("7fccf5c3-d328-4944-a4be-e73d5bd5c64c"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Url = "https://www.hatchwise.com/wp-content/uploads/2022/05/amazon-logo-1024x683.png"
                        },
                        new
                        {
                            Id = new Guid("402a4ea8-57ea-457a-b3e9-932ec81483b2"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Url = "https://www.hatchwise.com/wp-content/uploads/2022/05/amazon-logo-1024x683.png"
                        },
                        new
                        {
                            Id = new Guid("299b8e0d-581f-420f-a335-5be552b22cda"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Url = "https://www.hatchwise.com/wp-content/uploads/2022/05/amazon-logo-1024x683.png"
                        },
                        new
                        {
                            Id = new Guid("f7703845-d88d-4398-8f97-6c6c02a8147f"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Url = "https://www.hatchwise.com/wp-content/uploads/2022/05/amazon-logo-1024x683.png"
                        },
                        new
                        {
                            Id = new Guid("16a76ca8-6275-4a7a-8125-6e4fb4daedda"),
                            Publicid = "test",
                            ShopId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Url = "https://www.hatchwise.com/wp-content/uploads/2022/05/amazon-logo-1024x683.png"
                        });
            ...
            modelBuilder.Entity("Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "026c0a83-c276-4c1a-800e-fb854089fcd1",
                            AccessFailedCount = 0,
                            Age = 36,
                            Birthday = new DateTime(2024, 6, 14, 16, 42, 0, 183, DateTimeKind.Local).AddTicks(3843),
                            ConcurrencyStamp = "f7132e04-71db-4c88-8b1e-d8c4588739a4",
                            ...
                            SecurityStamp = "ed7dc4b6-a7cd-4cdb-bea5-a2591679d796",
